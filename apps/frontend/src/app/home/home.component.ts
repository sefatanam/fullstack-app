...
@Component({
  ...
  template: `
    <section class="flex h-full w-full justify-center items-center flex-col">
      ...
      >
        Here at you will find Angular, NestJS and Prisma.
      </p>
      <a
        href="https://nx.dev/"
        target="_blank"
        class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white bg-accent rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 "
      >
        Learn more
        <svg
